                                ...
                                <div class="form-box">
                                    ...
                                    <!--   
                                        ...
                                        if($this->session->userdata('sess_logged_in') == 0){?>
                                            <a href="<?php echo $google_login_url; ?>" class="btn btn-danger btn-block" style="margin: 1em 0;"><i class="fa fa-google"></i> GOOGLE LOGIN</a>
                                        <?php }else{?>
                                            <a href="<?php base_url()?>auth/logout" class="waves-effect waves-light btn red"><i class="fa fa-google"></i>Google logout</a>
                                        <?php }
                                        ?>
