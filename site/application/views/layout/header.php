...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/markdown/css/markdown-toolbar.css" type="text/css">
    ...
    <script src="<?php echo base_url(); ?>assets/plugins/markdown/js/markdown-toolbar.js"></script>
</head>
        ...
        <!-- Brand and toggle get grouped for better mobile display -->
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    <img alt="Brand" src="<?php echo base_url(); ?>assets/images/icone_simbolo.png" style="width:4em">
                </a>
            </div>
