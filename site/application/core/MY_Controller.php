...
class MY_Controller extends CI_Controller {
	...
	protected function _googleauth(){
		$this->data['googleuserdata'] = $this->session->userdata('googleuserdata');

		if(( !$this->data['googleuserdata'] ) || ($this->data['googleuserdata']['sess_logged_in'] == 0)) {
			redirect("/auth/login?r=".base64_encode( str_replace(base_url(), "", current_url())) );
		}
	}
